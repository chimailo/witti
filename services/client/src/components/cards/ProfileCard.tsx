...
import { useFollowUser } from '../../lib/hooks/auth';
...
export default function ProfileCard({ user, page, cacheKey }: IProps) {
    ...
    <Paper elevation={0} classes={{ root: classes.paper }}>
      <Box display='flex'>
        <Avatar
          ...
          alt={`${user.auth.username} gravatar`}
            ...
            <Fragment>
              <Box display='flex' alignItems='center'>
                ...
                >
                  ...
                  joined:{' '}
                  {user &&
                    new Date(user.profile.created_on).toLocaleDateString(
                      'en-gb',
                      {
                        month: 'short',
                        year: 'numeric',
